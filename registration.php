<?php
	...
	function hsu_conn_sess($usr, $pwd)
    {
		...
		if($num == 1)
		{
			...
			$qy = "insert into quizRegistration(name, password) values('$usr', '$pwd')";
			//oci_parse($connctn, $qy);
			mysqli_query($connctn, $qy);
		}
		/*
		oci_execute($register_stmt, OCI_DEFAULT);
		while(oci_fetch($register_stmt))
		{
